...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      admin_student_lifetime_accuracy: "Lifetime accuracy (Got it vs Again)",
      ...
      admin_student_mode_wrong_retry: "wrong cards only",
      ...
      flashcard_session_sample_hint:
        "This session practises {n} random cards from {total} in this deck. Use Got it or Again for each.",
      flashcard_session_full_hint: "This session runs through all {n} cards once. Use Got it or Again for each.",
      ...
      flashcard_complete_summary: "You answered {correct} correctly and tapped Again on {wrong} cards (out of {total}).",
      flashcard_complete_wrong_only: "Study wrong cards only",
    ...
    fr: {
      ...
      admin_student_lifetime_accuracy: "Précision globale (OK vs Encore)",
      ...
      admin_student_mode_wrong_retry: "cartes ratées seulement",
      ...
      flashcard_again: "Encore",
      flashcard_got_it: "OK",
      flashcard_score_label: "Score : {correct}/{attempts}",
      flashcard_session_sample_hint:
        "Cette session mélange {n} cartes au hasard sur {total}. Utilise OK ou Encore pour chaque carte.",
      flashcard_session_full_hint:
        "Cette session parcourt les {n} cartes une fois. Utilise OK ou Encore pour chaque carte.",
      ...
      flashcard_complete_summary:
        "Tu as {correct} bonnes réponses et {wrong} « Encore » sur {total} cartes.",
      flashcard_complete_wrong_only: "Revoir seulement les cartes ratées",
