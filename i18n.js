...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      account_err_register_fields: "Please enter full name, account name, password, and confirmation.",
      ...
      learning_progress_xp: "XP",
      learning_progress_streak: "Day streak",
      learning_progress_flash_accuracy: "Flashcard accuracy",
      learning_progress_quiz_sessions: "Quiz sessions",
      learning_progress_exercises_done: "Topics completed",
      learning_progress_week_activity: "Last 7 days",
      learning_progress_plan: "Upcoming class plan",
      learning_progress_badges: "Achievements",
      learning_progress_badge_xp50: "Reach 50 XP",
      learning_progress_badge_streak3: "3-day streak",
      ...
      learning_badge_earned: "★ ",
      learning_badge_unearned: "○ ",
      learning_level_xp_progress: "{current} / {goal} XP",
      ...
      learning_ex_practice_congrats: "Congratulations! You earned 20 XP for completing the practice task.",
    ...
    fr: {
      ...
      account_err_register_fields: "Veuillez indiquer le nom complet, le nom du compte, le mot de passe et la confirmation.",
      ...
      learning_progress_quiz_sessions: "Sessions de quiz",
      learning_progress_exercises_done: "Thèmes complétés",
      learning_progress_week_activity: "7 derniers jours",
      learning_progress_plan: "Planning des cours",
      learning_progress_badges: "Succès",
      learning_progress_badge_xp50: "Atteindre 50 XP",
      learning_progress_badge_streak3: "Série de 3 jours",
      ...
      learning_gap_complete_review: "Revois la leçon et réessaie !",
      learning_gap_restart: "Recommencer",
      learning_ex_practice_congrats: "Félicitations ! Tu as gagné 20 XP en terminant la tâche d'entraînement.",
      learning_exercise_intro_en_fallback:
        "This lesson covers {topic}. Read the explanation in both languages, work through each example, then complete the practice task in your notebook.",
      learning_exercise_intro_fr_fallback:
        "Cette leçon porte sur {topic}. Lis l'explication dans les deux langues, fais tous les exemples, puis termine la tâche d'entraînement dans ton cahier.",
